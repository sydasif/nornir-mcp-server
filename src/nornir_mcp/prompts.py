    ...
    return [
        {
            ...
            "content": (
                ...
                "1. `get_bgp_neighbors` to check the neighbor state. "
                "2. `get_bgp_neighbors_detail` to get detailed information about the session. "
                "3. `get_bgp_config` to check the BGP configuration. "
    ...
    return [
        {
            ...
            "content": (
                ...
                "1. `get_interfaces` to get a quick overview of all interface statuses. "
                "2. `get_interfaces_detailed` to check the detailed status, line protocol, and input/output rates. "
                "3. `get_interfaces_counters` to check for specific hardware or protocol errors. "
                "4. `get_device_configs` to validate the configuration. "
